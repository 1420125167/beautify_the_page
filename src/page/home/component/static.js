			...
			<Row gutter={16}>
				<Col className='gutter-row' span={6} offset={1}>
					<img style={{ width: 229, height: 108 }}
							 src={'https://storagecdn.xuetangx.com/public_assets/xuetangx/xuetangX2018/3f4f4e65069d59c139736f07295e2df7.15580847143191.png'}></img>
				</Col>
				<Col className='gutter-row' span={6}>
					<img style={{ width: 229, height: 108 }}
							 src={'https://qn-next.xuetangx.com/15740725373067.png?imageslim'}></img>
				</Col>
				<Col className='gutter-row' span={6}>
					<img style={{ width: 229, height: 108 }}
							 src={'https://qn-next.xuetangx.com/15735507062765.png?imageslim'}></img>
				</Col>
				<Col className='gutter-row' span={5}>
					<img style={{ width: 229, height: 108 }}
							 src={'https://qn-next.xuetangx.com/16418109871903.png?imageslim'}></img>
				</Col>
			</Row>
		)
	}
